// Security 설정 - /api/admin/**은 role=admin만, /api/posts/**·/api/bookmarks/**·/api/mypage/**·/api/files/**·/api/announcements/**·/api/notifications/**·/api/dashboard/**는 로그인 필요, 나머지(홈 요약/순위보드 등)는 전체 허용
